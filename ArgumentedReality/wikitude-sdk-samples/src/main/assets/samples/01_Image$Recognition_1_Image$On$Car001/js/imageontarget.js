var World = {
	...
	createOverlays: function createOverlaysFn() {
		...
		*/
        this.targetCollectionResource = new AR.TargetCollectionResource("assets/car1.wtc", {
        });
		...
		*/
		...
		var  sound1 = new AR.Sound("assets/zebra.mp3", {
                      onLoaded : function(){
...
var weatherWidget = new AR.HtmlDrawable({html:" <img src='http://5.189.188.154/ar/car001.png'>"}, 1, {
  offsetX : 1,
  onClick : function() {
  ...
  opacity : 0.9
	...
	worldLoaded: function worldLoadedFn() {
		...
		document.getElementById('loadingMessage').innerHTML =
			...
			"<div" + cssDivRight + "><img src='assets/car001.png'></img></div>";
