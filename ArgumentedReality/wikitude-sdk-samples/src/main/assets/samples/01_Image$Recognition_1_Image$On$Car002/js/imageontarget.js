var World = {
	...
	createOverlays: function createOverlaysFn() {
		...
		*/
        this.targetCollectionResource = new AR.TargetCollectionResource("assets/car2.wtc", {
        });
...
var weatherWidget = new AR.HtmlDrawable({html:" <img src='http://5.189.188.154/ar/car2.png'>"}, 1, {
  offsetX : 1,
  onClick : function() {
  ...
  opacity : 0.9
	...
	worldLoaded: function worldLoadedFn() {
		...
		document.getElementById('loadingMessage').innerHTML =
			...
			"<div" + cssDivRight + "><img src='assets/car02.png'></img></div>";
